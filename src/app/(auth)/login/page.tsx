...
export default function LoginPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center relative overflow-hidden bg-[var(--ghost-bg)]">
            ...
            {/* Background Decor */}
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-[var(--ghost-primary)] opacity-10 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col items-center animate-fade-in w-full max-w-sm">
                <div className="mb-6 relative group cursor-default">
                    <div className="absolute inset-0 bg-[var(--ghost-accent)] blur-2xl opacity-20 rounded-full group-hover:opacity-30 transition-opacity" />
                ...
                <p className="text-sm text-[var(--ghost-text-muted)] mb-8 max-w-[250px]">
                    Enter the realm to find your connections.
                </p>

                {/* Email Login Form */}
                <form onSubmit={handleLoginKey} className="w-full flex flex-col gap-3 mb-6">
                ...
                <div className="mt-8 text-sm text-[var(--ghost-text-muted)]">
                    Don't have a soul yet? <Link href="/signup" className="text-[var(--ghost-accent)] hover:underline font-medium ml-1">Sign up</Link>
                </div>
            </div>
        </div>
    );
